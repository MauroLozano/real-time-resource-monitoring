  ...
  return (
    <section className={`${styles.staticSection} `}>
      ...
      <div className={styles.scrollableContainer}>
        <div
          className={`${isCollapsed ? styles.staticSectionContentCollapsed : ''}`}
        >
          <h1 className={styles.sectionTitle}>System Components</h1>
          <ComponentCard icon={<ProcessorIcon />} title={'CPU'}>
            <ComponentAttribute
              label="Brand"
              value={staticData.cpu.brand}
            ></ComponentAttribute>
            <ComponentAttribute
              label="Manufacturer"
              value={staticData.cpu.manufacturer}
            ></ComponentAttribute>
            <ComponentAttribute
              label="Physical Cores"
              value={staticData.cpu.physicalCores}
            ></ComponentAttribute>
          </ComponentCard>
          ...
          <ComponentCard icon={<MachineIcon />} title={'OS'}>
            <ComponentAttribute
              label="Hostname"
              value={staticData.os.hostname}
            ></ComponentAttribute>
            <ComponentAttribute
              label="Platform"
              value={staticData.os.platform}
            ></ComponentAttribute>
            <ComponentAttribute
              label="Architecture"
              value={staticData.os.architecture}
            ></ComponentAttribute>
            <ComponentAttribute
