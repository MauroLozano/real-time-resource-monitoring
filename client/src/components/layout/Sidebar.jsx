  ...
  return (
    <>
      ...
      >
        ...
        <div
          className={`${styles.sidebarContent} ${isCollapsed ? styles.sidebarContentCollapsed : ''}`}
        >
          <h1 className={styles.sidebarTitle}>Monitoring Views</h1>
          <h2 className={styles.componentName}>CPU</h2>
          <SidebarElement
            onClick={() => setView('CPUGeneralView')}
            viewName={'CPUGeneralView'}
            activeView={activeView}
            text="General View"
          ></SidebarElement>
          <SidebarElement
            onClick={() => setView('CPUCoresView')}
            viewName={'CPUCoresView'}
            activeView={activeView}
            text="View by Cores"
          ></SidebarElement>
          <h2 className={styles.componentName}>Memory</h2>
          <SidebarElement
            onClick={() => setView('MEMAvailableView')}
            viewName={'MEMAvailableView'}
            activeView={activeView}
            text="View free and used"
          ></SidebarElement>
