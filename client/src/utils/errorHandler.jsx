    ...
    CPU_TEMP_SENSORS: (platform, reason) => {
        const messages = {
            ...
            DEFAULT: 
                ...
                : platform === 'linux' ?
                    <span>No CPU sensors detected <br />Are dependencies installed?</span>
                : 
...
export default function getErrorMsg(id, platform, reason = 'DEFAULT'){
    const errors = {
        //CPU STATS
        [metricsIds.CPU_AVG_TEMP]: ()=> ERROR_MSG.CPU_TEMP_SENSORS(platform, reason),
        [metricsIds.CPU_MAX_TEMP]: ()=> ERROR_MSG.CPU_TEMP_SENSORS(platform, reason), 
        ...
        //CORE STATS
        [metricsIds.CORE_MAX_TEMP]: ()=> ERROR_MSG.CPU_TEMP_SENSORS(platform, reason),
        [metricsIds.THERMAL_HEADROOM]: ()=> ERROR_MSG.CPU_TEMP_SENSORS(platform, reason),
